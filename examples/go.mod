module github.com/oktacode/rest-layer/examples
...
require (
	...
	github.com/oktacode/rest-layer v0.1.0
	github.com/oktacode/rest-layer-hystrix v0.0.0-20170801073253-2b89f63b98ec
...
replace github.com/oktacode/rest-layer => ./../
